...
lockPref("librewolf.cfg.version", "8.5");
lockPref("another.settings.version", "1.0")
...
// Another Web team specific settings
...
// Modified by Another Web team.
// Keeping browsing history is important to use browser as daily-driver.
...
// Modified by Another Web team.
// We prefer Cloudflare DoH for several reasons described in FAQ.
defaultPref("network.trr.mode", 3);
defaultPref("network.trr.uri", "https://mozilla.cloudflare-dns.com/dns-query");
 ...
 */
// Modified by Another Web team.
// We think that prefetching is not really a privacy-invasing feature, while it increases loading speeds.
...
// Modified by Another Web team.
/* We think that locally hosted LLMs are good for web in general.
But we do block remote hosts of LLMs, because for privacy purposes. */
defaultPref("browser.ml.enable", true);
defaultPref("browser.ml.chat.enabled", true);
defaultPref("browser.ml.modelHubRootUrl", "");
defaultPref("browser.ml.chat.provider", "http://localhost:8080");
